                ...
                <?php while ($room = mysqli_fetch_assoc($q_ruangan_sidebar)): ?>
                    <a href="ruangan.php?id=<?= (int) $room['id_ruangan']; ?>" style="text-decoration: none; color: inherit;">
                        <div class="widget-card"
                            style="height: 100%; min-height: 140px; display: flex; flex-direction: column; justify-content: space-between;">
                            <div style="display: flex; justify-content: space-between; align-items: center; gap: 8px;">
                                <span
                                    style="font-size: 18px; font-weight: 700; color: #0f172a;"><?= htmlspecialchars($room['nama_ruangan']); ?></span>
                                <span class="badge"
                                    style="background: rgba(15, 118, 110, 0.12); color: #0f766e; padding: 6px 10px; font-size: 12px; min-width: 32px; text-align: center;">
    ...
    <div class="table-container">
        ...
        <form method="GET" action="ruangan.php" class="filter-container" id="filterForm">
            ...
            <div class="filter-item" style="flex: 1; min-width: 180px;">
                ...
                <input type="text" name="search" id="searchInput" class="search-box-input"
                    placeholder="Kode barang, Barang..." value="<?= htmlspecialchars($keyword); ?>"
            ...
            <div class="filter-item">
                ...
                <select name="filter_kondisi" class="filter-select" onchange="this.form.submit()">
                    ...
                    <option value="cukup baik" <?= $filter_kondisi === 'cukup baik' ? 'selected' : ''; ?>>Cukup Baik
                    </option>
                    <option value="rusak" <?= $filter_kondisi === 'rusak' ? 'selected' : ''; ?>>Rusak</option>
                    <option value="rusak parah" <?= $filter_kondisi === 'rusak parah' ? 'selected' : ''; ?>>Rusak Parah
                    </option>
        ...
        <form method="POST" action="ruangan.php?id=<?= $id_ruangan; ?>" id="formHapusMassal">
                        ...
                        while ($row = mysqli_fetch_assoc($q_list)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="font-size: 12px; color: #94a3b8;"><?= htmlspecialchars($row['deskripsi']); ?>
                                    </div>
                                </td>
            ...
            <div id="selectedActions" class="selected-actions"
