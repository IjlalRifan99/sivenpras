...
if (isset($_GET['action']) && $_GET['action'] === 'export_excel') {
    ...
    $sheet .= '<cols><col min="1" max="1" width="8" customWidth="1"/><col min="2" max="2" width="20" customWidth="1"/><col min="3" max="4" width="28" customWidth="1"/><col min="5" max="6" width="18" customWidth="1"/><col min="7" max="7" width="16" customWidth="1"/><col min="8" max="8" width="35" customWidth="1"/></cols><sheetData>';
    $sheet .= '<row r="1" ht="24" customHeight="1"><c r="A1" t="inlineStr" s="3"><is><t>' . $xml('SMK TARUNA BANGSA') . '</t></is></c></row>';
    $sheet .= '<row r="2" ht="20" customHeight="1"><c r="A2" t="inlineStr" s="3"><is><t>' . $xml('LAPORAN DATA INVENTARIS SARANA DAN PRASARANA') . '</t></is></c></row>';
    $sheet .= '<row r="3"><c r="A3" t="inlineStr" s="3"><is><t>' . $xml('Tanggal Cetak: ' . date('d F Y')) . '</t></is></c></row>';
    ...
    $workbook = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"><sheets><sheet name="Laporan Inventaris" sheetId="1" r:id="rId1"/></sheets><definedNames><definedName name="_xlnm.Print_Titles" localSheetId="0">&apos;Laporan Inventaris&apos;!$1:$4</definedName><definedName name="_xlnm.Print_Area" localSheetId="0">&apos;Laporan Inventaris&apos;!$A$1:$H$' . $signature_name_row . '</definedName></definedNames></workbook>';
